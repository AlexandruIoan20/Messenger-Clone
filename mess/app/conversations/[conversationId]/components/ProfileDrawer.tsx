...
const ProfileDrawer = ({ data, isOpen, onClose }: ProfileDrawerProps) => {
    ...
    const joinedDate = useMemo( () => { 
        return otherUser != undefined ? format(new Date(otherUser.createdAt!), "PP") : undefined; 
    }, [otherUser?.createdAt]); 
        ...
        <Transition.Root show = { isOpen } as = { Fragment }>
            <Dialog as = "div" className = 'relative z-50' onClose = { onClose }>
                <Transition.Child 
                    ...
                    leaveTo="opacity-0"
                    //special atributes from headless ui
                >
                    <div
                ...
                <div className = 'fixed inset-0 overflow-hidden'>
                    <div className = 'absolute inset-0 overflow-hidden'>
                        <div className = 'pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10'>
                            ...
                            <Transition.Child
                                as = { Fragment }
                                enter = "transform transition ease-in-out transition-500"
                                                        ...
                                                        { data.isGroup && 
                                                            ( 
                                                                <div>
                                                                    ...
                                                                    <dd className = 'empty-1 text-sm text-gray-900 sm:col-span-2'>
